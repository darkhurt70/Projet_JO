...
<div class="container">
    <?php foreach ($listPersonnage as $perso): ?>
        ...
        ?>
        <div class="card <?= $this->e($elementName); ?> <?= $this->e($rarity); ?>">
            <img src="<?= $this->e($perso->getUrlImg()); ?>" alt="<?= $this->e($perso->getName()); ?>">
            <div style="padding: 10px;">
                <h4><?= $this->e($perso->getName()); ?></h4>
                <p>Élément : <?= $this->e($elementObj->getName()); ?></p>
                <p>Classe : <?= $this->e($unitclassObj->getName()); ?></p>
                <p>Origine : <?= $this->e($originObj->getName()); ?></p>
